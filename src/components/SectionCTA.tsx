...
export function SectionCTA() {
    return (
        <div className="hidden lg:flex justify-center mt-20">
          ...
          bg-[#111820] text-[#C9B99B] rounded-full
          border border-[#111820]/45
        ...
        "
            >
                ...
                <div className="w-10 h-10 rounded-full bg-[#C9B99B] flex items-center justify-center text-[#F9F7F2] transition-transform group-hover:rotate-45">
                    <ArrowRight size={20} />
                </div>
